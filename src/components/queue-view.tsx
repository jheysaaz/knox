          ...
          <div className="space-y-2">
            {files.map((file) => (
              ...
              >
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <span
                      className={cn(
                        ...
                        file.status === "processing" && !isRunning && "text-amber-500",
                        file.status === "processing" && isRunning && "text-blue-500",
                ...
                {(file.status === "complete" || file.status === "error" || file.status === "paused") && (
                  <Button
                    variant="ghost"
                    size="sm"
